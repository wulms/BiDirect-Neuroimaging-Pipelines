...
```{r}
# input folders
freesurfer_license = "/mnt/Storage1/bidirect_processing/fmriprep/license.txt"

input_BIDS <- "/mnt/Storage1/bidirect_projektbox/BiDirect_Neuroimaging/Bidirect_BIDS/bids/sourcedata"

# output folders
output_fmriprep <- "/mnt/Storage1/bidirect_processing/fmriprep/out"
work_fmriprep <- "/mnt/Storage1/bidirect_processing/fmriprep/work"
# here are the files copied and removed.
temp_batch_fmriprep <- "/mnt/Storage1/bidirect_processing/fmriprep/temp"
...
```{r}
unprocessed_df %>% mutate(indices = group_indices(.))
```
