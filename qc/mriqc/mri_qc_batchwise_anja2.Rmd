...
## folders
```{r}
input_BIDS <- "/mnt/spaceC/sciebo_projektbox/BiDirect_Neuroimaging/Bidirect_BIDS/bids/sourcedata/"

output_MRIQC <- "/media/niklas/Storage3/mriqc/out"
# here are the files copied and removed.
temp_batch_MRIQC <- "/media/niklas/Storage3/mriqc/temp"
