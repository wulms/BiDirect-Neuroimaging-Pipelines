...
output_nii <- data.frame(
  T1 = folderpath(input_nii$T1, "anat_T1_BET_05"),
  T1_cropped = folderpath(input_nii$T1_cropped, "anat_T1_crop_BET_05"),
  T1_reorient2std = folderpath(input_nii$T1_reorient2std, "anat_T1_reorient2std_BET_05"),
  T1_defaced_pydeface = folderpath(input_nii$T1_defaced_pydeface, "anat_T1_defaced_pydeface_BET_05"),
  T1_defaced_mri_deface = folderpath(input_nii$T1_defaced_mri_deface, "anat_T1_defaced_mri_deface_BET_05"),
  T1_cropped_defaced_pydeface = folderpath(input_nii$T1_cropped_defaced_pydeface, "anat_T1_cropped_defaced_pydeface_BET_05"),
  T1_cropped_defaced_mri_deface = folderpath(input_nii$T1_cropped_defaced_mri_deface, "anat_T1_cropped_defaced_mri_deface_BET_05"),
  T1_r2std_defaced_pydeface = folderpath(input_nii$T1_r2std_defaced_pydeface, "anat_T1_r2std_defaced_pydeface_BET_05"),
  T1_r2std_defaced_mri_deface = folderpath(input_nii$T1_r2std_defaced_mri_deface, "anat_T1_r2std_defaced_mri_deface_BET_05"),
  stringsAsFactors = FALSE)
